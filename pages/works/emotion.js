...
const Projects = () => (
  <Layout title="NLP Model Eval.">
    <Container>
      ...
      <P>
        A project I completed under the supervision of NLP experts at Northeastern University.
      ...
      <P>
        The models were Logistic Regression, LSTM, and a 
      ...
      <Center my={6}>
        <Image src="/images/works/distilbert.ong" alt="cm" />
      </Center>
    </Container>
  </Layout>
)
